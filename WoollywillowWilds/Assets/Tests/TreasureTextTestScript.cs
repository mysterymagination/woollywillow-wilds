...
public class TreasureTextTestScript
{
    ...
    public void ParseMoodAnnotationHappyPath()
    {
        ...
        TreasureSentence case1_expectedSentence2 = new TreasureSentence(Mood.Sultry, "Her name's Lily Littlebush.");
        TreasureSentence case1_expectedSentence3 = new TreasureSentence(Mood.Happy, "Let's take a look at her story:");
        TreasureSentence case1_expectedSentence4 = new TreasureSentence(Mood.Happy, "she sits in the center of the garden, keeping good and gentle watch, patting puppies as they play.");
